      ...
      <SafeAreaView>
        ...
        <View style={styles.shadowbar}>
          <View style={[styles.button11]}>
            <View style={{ width: "40%" }}>
              <Text style={styles.text12}>Botón de pánico:</Text>
            </View>
            <View style={{ width: "40%" }}>
              <Text style={styles.text13}>{userInfo.panicbutton}</Text>
            </View>
          </View>
          <View style={[styles.button11]}>
            <View style={{ width: "40%" }}>
              <Text style={styles.text12}>Fecha de ocurrencia:</Text>
            </View>
            <View style={{ width: "40%" }}>
          ...
          <View style={[styles.button11]}>
            ...
            <View style={{ width: "40%" }}>
              <Text style={styles.text13}>{userInfo.action}</Text>
            </View>
          </View>
          <View style={[styles.button11]}>
            <View style={{ width: "40%" }}>
            ...
            <View style={{ width: "40%" }}>
              <Text style={styles.text13}>{userInfo.actor}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.shadowbar}>
          <View style={[styles.button11, { height: 30 }]}>
            <View style={{ width: "40%" }}>
              <Text style={styles.text12}>Geolocalización</Text>
            </View>
